...
type Emulator interface {
	...
	// Read reads terminal response data generated by the emulator (e.g.,
	// responses to OSC color queries, DSR cursor position reports). The
	// caller must continuously drain this to prevent Write from blocking
	// when the emulator generates responses while holding its mutex.
	io.Reader
