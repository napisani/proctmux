...
ZIG_E2E_RUN ?= TestUnified_(RapidStdout_NoExcessiveRepaints|SideBySidePanesStaySeparatedWithLongProcessLabels|Keypress_NoExcessiveFullClears|CursorHiddenDuringNavigationAndOutput|ProcessSwitchToStoppedShowsOnlyPlaceholder|ProcessSwitchRunningToRunningShowsOnlyActiveOutput|SelectNeverRunProcessShowsNoProcessBanner|SelectExitedProcessShowsLastRunOutput|StartSelectedStoppedProcessShowsItsOutput|RestartSelectedProcessShowsRestartedOutput)
